...
return obj[key]}
return{}};return this};this.now=function(){return Math.floor((new Date()).getTime()/1000)};this.clone=function(obj){if(Array.isArray(obj)){return obj.splice()}
...
http.send(query);return http};return this})();var jNArray=function(data){this._array=[];if(typeof data!="undefined"){this._array=data}
