...
return this};this.odd=function(callback){this.each(function($element,key){if(key%2){callback($element)}});return this};this.even=function(callback){this.each(function($element,key){if(!(key%2)){callback($element)}});return this};this.files=function(){return this._call.call(this,{callback:'_files'})};this._files=function(){return this._d.files};this.findAll=function(selector){return new jNet.jNDocQuery(this._call.call(this,{callback:'_findAll',selector:selector}))};this._findAll=function(obj){var _tmp=new jNet.jNArray();var _arr=this._d.querySelectorAll(obj.selector.selectorReplaceId());for(var i=0;i<_arr.length;++i){_tmp.push(new jNet.jNDocQuery(_arr[i]))}
return _tmp};this.find=function(selector){return this._call.call(this,{callback:'_find',selector:selector})};this._find=function(obj){var _tmp=new jNet.jNDocQuery(this._d);_tmp._d=this._d.querySelector(obj.selector.selectorReplaceId());return _tmp};this.toString=function(){return '[jNDocQuery]'};this.classList=function(){return this._call.call(this,{callback:'_classList'})};this._classList=function(){var _classList=this._d.classList;if(typeof _classList=='undefined'){return new jNet.jNArray()}
...
return this._d.outerHTML};this.insertAfter=function($element){$element=new jNet.jNDocQuery($element);return this._call.call(this,{callback:'_insertAfterBefore',element:$element.first(),insertBefore:!1})};this.insertBefore=function($element){$element=new jNet.jNDocQuery($element);return this._call.call(this,{callback:'_insertAfterBefore',element:$element.first(),insertBefore:!0})};this._insertAfterBefore=function(obj){obj.element._d.parentNode.insertBefore(this._d,obj.element._d.nextSibling);if(obj.insertBefore){this._d.parentNode.insertBefore(obj.element._d,this._d.nextSibling)}
