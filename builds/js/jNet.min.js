...
return this._d.outerHTML};this.prepend=function(html){return this._call.call(this,{callback:'_prepend',html:html})};this._prepend=function(obj){var html=obj.html;if(typeof html=='string'){html=html.jNToDocument()}
...
if(typeof html.body.firstChild!='undefined'){this._d.insertBefore(html.body.firstChild,this._d.firstChild)}
return this};this.append=function(html){return this._call.call(this,{callback:'_append',html:html})};this._append=function(obj){var html=obj.html;if(typeof html=='string'){html=html.jNToDocument()}
else{switch(html.toString()){case jNet.jNDocQuery().toString():html=html._outerHTML().jNToDocument();break}}
if(typeof html.outerHTML!='undefined'){html=html.outerHTML.jNToDocument()}
