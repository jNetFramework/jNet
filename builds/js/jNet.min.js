...
return _arr}
return this[args.callback].call(this,args)};this.each=function(callback){if(this._array.length()){return this._array.forEach(callback)}
callback(this);return this};this.reverse=function(){if(this._array.length()){return this._array.reverse()}
