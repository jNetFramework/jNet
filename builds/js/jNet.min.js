...
return this._d.outerHTML};this.insertAfter=function($element){$element=new jNet.jNDocQuery($element);return this._call.call(this,{callback:'_insertAfter',element:$element.first()})};this._insertAfter=function(obj){obj.element._d.parentNode.insertBefore(this._d,obj.element._d.nextSibling);return this};this.insertBefore=function($element){$element=new jNet.jNDocQuery($element);return this._call.call(this,{callback:'_insertBefore',element:$element.first()})};this._insertBefore=function(obj){obj.element._d.parentNode.insertBefore(this._d,obj.element._d.nextSibling);this._d.parentNode.insertBefore(obj.element._d,this._d.nextSibling);return this};this.append=function(html){return this._call.call(this,{callback:'_prependAppend',html:html,type:'append'})};this.prepend=function(html){return this._call.call(this,{callback:'_prependAppend',html:html,type:'prepend'})};this._prependAppend=function(obj){var html=obj.html;if(typeof html=='string'){html=html.jNToDocument()}
