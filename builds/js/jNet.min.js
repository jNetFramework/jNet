...
this.animate({duration:obj.options.duration,delta:function(progress){progress=this.progress;return self._easing().swing(progress)},complete:obj.options.complete,step:function(delta){if(obj.to){self._d.style.opacity=obj.to-delta}
